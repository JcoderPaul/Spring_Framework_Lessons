...
- [Comparable<HttpStatus>](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html),
- [Constable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/constant/Constable.html),
- [HttpStatusCode](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/http/HttpStatusCode.html)
...
Серию кодов состояния HTTP можно получить через метод [*.series()](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/http/HttpStatus.html#series()).

---
#### Вложенные классы

- static enum - HttpStatus.Series - Перечисление серий [статусов HTTP см.](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/http/HttpStatus.Series.html)

---
#### Вложенные классы/интерфейсы, унаследованные от класса [Enum](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html#nested-class-summary)
...
- `static HttpStatus[] values()` - Возвращает массив, содержащий константы этого класса перечисления, в том порядке, в котором они объявлены.

---
- Методы, унаследованные от класса [Enum](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html#method-summary): clone, compareTo, describeConstable, equals, finalize, getDeclaringClass, hashCode, name, ordinal, valueOf
- Методы, унаследованные от класса [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html#method-summary): getClass, notify, notifyAll, wait, wait, wait
- Методы, унаследованные от интерфейса [HttpStatusCode](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/http/HttpStatusCode.html#method-summary): isSameCodeAs

---
**Доп. материал:**
- [Java Enums With All HTTP Status Codes](https://www.baeldung.com/java-enum-http-status)
- [Uses of Enum Class org.springframework.http.HttpStatus](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/http/class-use/HttpStatus.html)
...
- [Updating to HttpStatusCode in Spring Boot 3](https://www.javacodegeeks.com/updating-to-httpstatuscode-in-spring-boot-3.html)
