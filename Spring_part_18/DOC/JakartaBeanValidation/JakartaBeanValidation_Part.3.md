...
методов и конструкторов. Валидация методов возможна при помощи интерфейса [ExecutableValidator](https://jakarta.ee/specifications/platform/10/apidocs/jakarta/validation/executable/executablevalidator), получить экземпляр которого можно при помощи метода forExecutables() интерфейса [Validator](https://jakarta.ee/specifications/platform/10/apidocs/jakarta/validation/validator), как это показано в следующем примере кода:
...
нескольким аргументам метода. 

Аннотация ограничения в этом случае применяется к самому методу, а не к аргументам:
