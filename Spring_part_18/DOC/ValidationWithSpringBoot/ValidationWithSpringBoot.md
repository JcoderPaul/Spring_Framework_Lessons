...
эту тему в моей статье [про антишаблоны Bean Validation](../ValidationAntiPatterns.md)
...
Подробнее об этой теме можно прочитать в моей статье [об антишаблонах проверки компонентов.](../ValidationAntiPatterns.md)
