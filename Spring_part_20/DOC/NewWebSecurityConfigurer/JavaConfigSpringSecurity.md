...
Конфигурация Java была добавлена в среду Spring в Spring 3.1 и расширена до [Spring Security в Spring 3.2](https://docs.spring.io/spring-framework/docs/3.2.x/spring-framework-reference/html/new-in-3.2.html)
и определена в классе с аннотацией @Configuration.
...
Последнюю версию всегда можно найти здесь - [Spring Security Core](https://mvnrepository.com/search?q=spring-security-core).
...
начиная с Spring 5, нам понадобится bean-компонент [PasswordEncoder](https://www.baeldung.com/spring-security-5-default-password-encoder):
...
аутентификации, очищает [SecurityContextHolder](https://docs.spring.io/spring-security/site/docs/4.0.x/apidocs/org/springframework/security/core/context/SecurityContextHolder.html) и перенаправляет на страницу входа.
...
Конечно, в обоих приведенных выше примерах нам также необходимо определить компонент [PasswordEncoder](https://docs.spring.io/spring-security/reference/api/java/org/springframework/security/crypto/password/PasswordEncoder.html), как описано в разделе выше.

---
**См. так же:**
- [Кодировщик паролей по умолчанию в Spring Security 5](https://www.baeldung.com/spring-security-5-default-password-encoder)
- [Базовая аутентификация Spring Security](https://www.baeldung.com/spring-security-basic-authentication)
