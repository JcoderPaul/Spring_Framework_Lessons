...
/* Lesson 122 - Изучаем работу @Around advice-ов */
...
@Aspect
/*
Указывает, что аннотированный класс является компонентом.
Такие классы рассматриваются как кандидаты на автоматическое
обнаружение при использовании конфигурации на основе аннотаций
и сканирования пути к классам.
*/
@Component
/* Аннотация позволяет управлять порядком следования Advice-ов */
@Order(2)
public class ThirdAspectAndAroundAdvice {
    ...
    */
    @Around("FirstAspect.anyFindByIdServiceMethod() && target(service) && args(id)")
