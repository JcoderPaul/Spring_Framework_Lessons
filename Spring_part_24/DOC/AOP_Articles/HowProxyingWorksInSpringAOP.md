- [См. исходники и дополнения (ENG)](https://medium.com/walmartglobaltech/understanding-the-worker-ants-of-spring-aop-proxies-902208881493)
...
подчеркнуть его ограничения. Если вы не знакомы с литературой по АОП, загляните сюда - ["AOP Concepts (from docs.spring.io)"](https://docs.spring.io/spring-framework/reference/core/aop/introduction-defn.html)
...
- **Динамический прокси JDK** - Spring AOP по умолчанию использует динамические прокси JDK, которые позволяют проксировать любой интерфейс (или набор интерфейсов). Всякий раз, когда целевой объект реализует хотя бы один интерфейс, будет использоваться динамический прокси JDK.
...
Рассмотрим пример для создания аспекта Logger, который регистрирует время, затраченное на каждый метод, помеченный @Loggable.
...
![AroundAdviceUMLCallDiagram.jpg](../AOP_Articles/images/AroundAdviceUMLCallDiagram.jpg)
...
проксирования. Следовательно, невозможно, чтобы аспекты сами по себе были целью Advice от других аспектов в Spring AOP.
...
- [Spring AOP: как работает проксирование](https://habr.com/ru/articles/597797/)
- [Механизмы проксирования](https://javarush.com/quests/lectures/questspring.level01.lecture64)
- [AOP Proxies](https://docs.spring.io/spring-framework/reference/core/aop/introduction-proxies.html)
- [Понимание прокси в Spring Boot: концепции, реализация и реальный пример](https://ru.linkedin.com/pulse/understanding-proxies-spring-boot-concepts-real-example-vahid-eslami-o7off?tl=ru)
- [Что такое Spring AOP (Aspect-Oriented Programming)?](https://talanto.work/interview-prep/spring-aop-purpose)
- [Spring AOP. Маленький вопросик с собеседования](https://habr.com/ru/articles/347752/)
