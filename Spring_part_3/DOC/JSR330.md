...
Для создания специальных аннотаций компонентов следует использовать модель стереотипов Spring, см.

![DOC/ComponentScans_to_TypeFilter.jpg](./DOC/ComponentScans_to_TypeFilter.jpg)
