...
/*
Part 10: Lesson 48 - 49 - применение интерфейса JpaRepository,
именованные запросы, стратегия создания запросов к БД на основании
имени метода запроса:
