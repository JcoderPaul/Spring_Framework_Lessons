...
Part 11: Lesson 60 - не магия, но удобство, т.к. мы работаем с FilterUserRepository
то обращение пойдет к уже готовому его bean-у, хотя мы в данном уроке подключили
(внедрили) JDBC и применяем метод с его функционалом (технологией).
*/
...
public class FilterUserRepositoryImpl implements FilterUserRepository {
    ...
    /*
    Part 11: Lesson 60 - SQL запрос для метода реализующего механизм JDBC -
    ...
    */
    private static final String FIND_BY_COMPANY_AND_ROLE = """
        ...
        """;
    /*
    Part 11: Lesson 61 - SQL запрос для метода реализующего batch запрос -
    *.updateCompanyAndRole()
    */
