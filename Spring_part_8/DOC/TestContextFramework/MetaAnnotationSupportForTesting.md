...
- [@Sql](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/test/context/jdbc/Sql.html) - [SQL Databases](https://docs.spring.io/spring-boot/reference/data/sql.html) - [article and example](https://www.baeldung.com/spring-boot-data-sql-and-schema-sql);
...
- [@SqlMergeMode](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/test/context/jdbc/SqlMergeMode.html) - [оф. док.](https://docs.spring.io/spring-framework/reference/testing/annotations/integration-spring/annotation-sqlmergemode.html);
