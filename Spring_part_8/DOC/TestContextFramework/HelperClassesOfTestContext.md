...
Подробнее об использовании аннотации [@TestConstructor](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/test/context/TestConstructor.html) и о том, как изменить режим автоматического обнаружения и связывания глобального тестового конструктора, см.в разделе, посвященном аннотации @TestConstructor см. ниже, доп. см. [TestConstructor](../../DOC/IntegrationTesting/TestConstructor.md).
