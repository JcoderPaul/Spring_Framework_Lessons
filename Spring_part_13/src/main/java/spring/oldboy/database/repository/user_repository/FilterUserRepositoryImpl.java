...
public class FilterUserRepositoryImpl implements FilterUserRepository {
    ...
    private static final String UPDATE_COMPANY_AND_ROLE = """
        ...
        """;
    /*
    Part 11: Lesson 61 - SQL запрос с именованными параметрами для метода реализующего batch
    запрос - *.updateCompanyAndRoleNamed см. DOC/SpringJDBC/NamedParameterJdbcTemplate.txt.
    Каждый параметр имеет имя и его мы применим при передаче параметров в метод.
    */
    ...
    */
    ...
    /*
    Part 10: Lesson 61 - реализуем метод с пакетным (batch) запросом.
    ...
    */
    ...
    /*
    Part 10: Lesson 61 - применим именование параметров в SQL запросе,
