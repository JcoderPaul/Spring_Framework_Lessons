...
---
- [См. исходную инф. (ENG)](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/web/bind/annotation/CookieValue.html)
- [Working with Cookies in Spring MVC using @CookieValue Annotation](https://www.geeksforgeeks.org/springboot/working-with-cookies-in-spring-mvc-using-cookievalue-annotation/)
- [@CookieValue](https://docs.spring.io/spring-framework/reference/web/webmvc/mvc-controller/ann-methods/cookievalue.html)
- [Working with Cookies in Spring MVC using @CookieValue Annotation](https://medium.com/@AlexanderObregon/working-with-cookies-in-spring-mvc-using-cookievalue-annotation-7979205bb349)
