- [См. исходник (ENG)](https://www.baeldung.com/csrf-thymeleaf-with-spring-security)

---
### Защита CSRF с помощью Spring MVC и Thymeleaf

**Thymeleaf** — шаблонизатор Java для обработки и создания HTML, XML, JavaScript, CSS и открытого текста. Знакомство с
Thymeleaf и Spring можно найти в этой статье - ["Introduction to Using Thymeleaf in Spring"](https://www.baeldung.com/thymeleaf-in-spring-mvc).
...
**CSRF** — атака, которая вынуждает, или стимулирует, конечного допропорядочного пользователя выполнять нежелательные действия 
в веб-приложении, или сервисе, которое на данный момент аутентифицировано.
...
thymeleaf-spring4. 5-ую версию зависимостей можно найти здесь - [Thymeleaf Spring5](https://mvnrepository.com/artifact/org.thymeleaf/thymeleaf-spring5)
...
В дополнение к конфигурации Thymeleaf, описанной здесь - [Introduction to Using Thymeleaf in Spring](https://www.baeldung.com/thymeleaf-in-spring-mvc), 
нам нужно добавить конфигурацию для Spring Security. 

Для этого нам нужно создать класс:
...
Более подробную информацию и описание конфигурации безопасности можно найти в серии [«Безопасность с помощью Spring»](https://www.baeldung.com/security-spring).
...
отправить форму мы получим страницу см. 

![CSRF_VERIFY_403.jpg](../DOC/CSRF/Image/CSRF_VERIFY_403.jpg)
