- [См. исходник (RUS)](https://blog.skillfactory.ru/glossary/csrf/)
...
отправлять сообщения, менять пароли, переводить деньги со счета на счет и т.п. 

В атаке используются недостатки протоколаHTTP.
