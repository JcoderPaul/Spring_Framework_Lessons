...
/*
Lesson 112: Мы можем аннотировать нашего абстрактного родителя
и тогда все интеграционные тесты получат тестового пользователя
для тестирования при подключенном Spring Security:
