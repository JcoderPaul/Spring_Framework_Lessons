...
1. - стандартное открытие и закрытие соединения JDBC. Это то, что @Transactional аннотация Spring делает для нас автоматически, без необходимости писать весь 'коммуникационный код' явно;
