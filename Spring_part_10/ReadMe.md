...
добавим аннотацию [@EnableEnversRepositories](https://docs.spring.io/spring-data/envers/docs/current/api/org/springframework/data/envers/repository/config/EnableEnversRepositories.html) или см. ["Annotation Type EnableEnversRepositories"](./DOC/DataEnvers/EnableEnversRepositories.md). Передадим в параметры аннотации наш корневой пакет для сканирования отслеживаемых объектов: `basePackageClasses = SpringAppRunner.class`
