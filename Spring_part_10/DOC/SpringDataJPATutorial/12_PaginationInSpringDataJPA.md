- [Исходник статьи (ENG)](https://www.petrikainulainen.net/programming/spring-framework/spring-data-jpa-tutorial-part-seven-pagination/)
...
- [Шаг 1. - **Получим объект Pageable**, который указывает информацию о запрошенной странице.](#step_1)
- [Шаг 2. - **Передадим объект Pageable правильному методу репозитория** в качестве параметра метода.](#step_2)

Давайте начнем с выяснения того, как мы можем получить объект Pageable.

---
<h3 id="step_1">Шаг 1. - Получение Pageable объекта</h3>
...
---
<h3 id="step_2">Шаг 2. - Передадим объект `Pageable` методу репозитория в качестве параметра</h3>
