...
При использовании Gradle в качестве примера можно изучить [наш build.gradle](../../build.gradle).
...
- Если мы **хотим реализовать уровень персистентности, использующий Spring Data JPA, нам нужны** следующие компоненты:
  - **Драйвер JDBC**,
  - **Источник данных (пул соединений с БД)**,
  - **Поставщик JPA (фреймворк реализующий JPA)**,
  - **Spring Data JPA (библиотека компанентов)**.
