...
public interface FilterUserRepository {
    ...
    */
    ...
    /*
    Part 11: Lesson 61: В данный метод мы передадим список пользователей
    (не одного, а именно список), чтобы одним пакетом обносить данные по
    ним, см. пояснения в DOC/Batch_JDBC_HIBERNATE.txt
    */
    void updateCompanyAndRole(List<User> users);

    /*
    Part 11: Lesson 61: Чтобы понять отличия запросов с именованными параметрами
    от параметризованных '?', см. DOC/SpringJDBC/NamedParameterJdbcTemplate.txt
    */
