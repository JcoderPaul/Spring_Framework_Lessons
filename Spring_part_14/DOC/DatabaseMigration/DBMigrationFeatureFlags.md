...
```
       ...
       Флаги функций — это программные средства, позволяющие отключать функции без изменения исходного кода или
       повторного развертывания. Их часто называют переключателями функций, переключателями релизов или
       переключателями функций. "Флаг функции" представляет собой простое условное выражение (например,
       «если» — «если»). Этот флаг функции определяет, когда происходит выполнение кода. Это позволяет
       развернуть новые функции, которые не будут отображаться для пользователей.
```
