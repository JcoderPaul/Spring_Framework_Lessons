...
- ["Миграция базы данных: что это такое и как это сделать"](./DOC/DatabaseMigration/DatabaseMigration.txt);
- ["Снижение риска миграции базы данных с помощью флагов функций"](./DOC/DatabaseMigration/DBMigrationFeatureFlags.txt);
- ["Руководство по началу работы с флагом Ultimate Feature"](./DOC/DatabaseMigration/FeatureFlag.txt);
