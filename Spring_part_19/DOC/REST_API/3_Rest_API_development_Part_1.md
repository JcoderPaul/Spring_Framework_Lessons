...
Потребитель должен знать детали предоставляемой услуги. По этой причине должен быть заключен договор. 
*Договор на обслуживание определяет*:
...
![3_IMG_6_WSDL.png](../REST_API/ARTICLE_IMAGE/3_IMG_6_WSDL.png)

WSDL обычно используется с веб-сервисами SOAP/XML. В таком случае вы обычно определяете:

![3_IMG_7_SOAP_XML.png](../REST_API/ARTICLE_IMAGE/3_IMG_7_SOAP_XML.png)
