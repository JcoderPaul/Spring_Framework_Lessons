...
![5_IMG_13_HATEOAS.png](../REST_API/ARTICLE_IMAGE/5_IMG_13_HATEOAS.png)
...
![5_IMG_14_GET_REQUEST.png](../REST_API/ARTICLE_IMAGE/5_IMG_14_GET_REQUEST.png)
...
![5_IMG_15_GET_RESPONSE_JSON.png](../REST_API/ARTICLE_IMAGE/5_IMG_15_GET_RESPONSE_JSON.png). 

Этот пример был в формате JSON. Формат XML для другого примера будет выглядеть примерно так: 

![5_IMG_16_GET_RESPONSE_XML.png](../REST_API/ARTICLE_IMAGE/5_IMG_16_GET_RESPONSE_XML.png)
...
![5_IMG_17_HAL_RESPONSE.png](../REST_API/ARTICLE_IMAGE/5_IMG_17_HAL_RESPONSE.png)
...
---
См. [комментарии к статье в русском исходнике](https://habr.com/ru/articles/483328/).
