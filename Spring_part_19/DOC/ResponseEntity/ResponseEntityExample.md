...
Для получения дополнительной информации см. [Spring’s RequestBody and ResponseBody Annotations](https://www.baeldung.com/spring-request-response-body)
...
Дополнительные примеры можно найти тут, см. [Using Spring @ResponseStatus to Set HTTP Status Code](https://www.baeldung.com/spring-response-status)

#### Управляйте ответом напрямую

Spring также позволяет нам напрямую обращаться к объекту [HttpServletResponse](https://docs.oracle.com/javaee/7/api/javax/servlet/http/HttpServletResponse.html); 
