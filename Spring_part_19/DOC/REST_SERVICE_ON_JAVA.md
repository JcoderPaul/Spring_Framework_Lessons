...
бы хотел показать, что при желании можно собрать приложение из довольно простых компонентов, не прибегая к мега-фреймворкам.
...
Там же мы забайндили (связали) Counter и Resource.
...
---
См. [комментарии к статье в исходнике](https://habr.com/ru/articles/115718/).
