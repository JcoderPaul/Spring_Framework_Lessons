- См. исходник (RUS): [ХАБР](https://habr.com/ru/articles/117321/)
- См. исходник (ENG): ссылка на блог Ryan Tomayko мертва (для этого и делаются копии материалов)))
...
**Райан:** Если это того стоит. Смотри, мы говорим об этом с большой долей абстракции. Давай возьмём реальный пример. Ты
       ...
       могла бы общаться с системами отдельных школ с целью сбора результатов тестов. 
...
---
См. [комментарии к статье в русском исходнике](https://habr.com/ru/articles/117321/).
