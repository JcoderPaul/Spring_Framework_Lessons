...
Долгое время программировал на java и spring boot 1.5. И тут возникла потребность написать новый проект:
...
конструктора без параметров, а потом вызывал *getter/setter*. 
...
![1_Parameters.png](../Java_Kotlin_RestController/1_Parameters.png)
...
Казалось бы java в рантайме не знает имен параметров в конструкторе, но почему то Spring Boot 2.0 уже умеет работать с data class.
...
---
[См. комментарии к статье в русском исходнике](https://habr.com/ru/articles/480158/).
