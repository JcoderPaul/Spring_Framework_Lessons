...
Пятая часть диссертации доступна по ссылке - ["CHAPTER 5 - Representational State Transfer (REST)"](https://ics.uci.edu/~fielding/pubs/dissertation/rest_arch_style.htm)
...
стандарту URL родилась химера «RESTful API», конкретного смысла которой никто не знает - ["What is REST?"](https://restfulapi.net/)

Хотим ли мы тем самым сказать, что REST является бессмысленной концепцией? Отнюдь нет. 

Мы только хотели показать, что она допускает чересчур широкую интерпретацию, в чём одновременно кроется и её сила, и её слабость.
...
---
См. [комментарии к статье в русском исходнике](https://habr.com/ru/articles/560590/).
