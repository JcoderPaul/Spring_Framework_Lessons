...
Кроме того, даже при использовании шаблонизатора, выбор расширяется:
...
Краткое введение в JAX-RS было дано в [JAX-RS-Basics-Part-1](../JAX-RS/JAX-RS-Basics-Part-1.md). И экспонированный через JAX-RS 
интерфейс может принимать GET и POST запросы с данными форм. О проблемах данного подхода при использовании не-latin-1 и пойдет 
речь в данной статье.

---
#### Получение данных формы в [JAX-RS](https://www.oracle.com/technical-resources/articles/java/jax-rs.html)
...
После этого и при использовании ClientRequest, и при использовании прокси-объектов в процессе отправки запроса при наличии 
заголовка *Content-Type* с *application/x-www-form-urlencoded*, но без *charset*, просто проставляется заголовок, его
содержащий.

---
См. комментарии [к статье в исходнике](https://habr.com/ru/articles/140270/).

---
**Доп. материал:**
- [Overview of JAX-RS (Part 1)](https://medium.com/@alextheedom/overview-of-jax-rs-part-1-da5289bdffe2)
- [Overview of JAX-RS Annotations (Part 2)](https://medium.com/@alextheedom/overview-of-jax-rs-annotations-part-2-1dd73f0195ba)
- [What are JAX-RS Annotations?](https://medium.com/@alextheedom/what-are-jax-rs-annotations-f5f560fe8e99)
