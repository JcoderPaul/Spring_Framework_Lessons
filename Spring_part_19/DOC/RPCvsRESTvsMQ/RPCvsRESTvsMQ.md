...
**MQ или Messages queue - очередь сообщений** - архитектура и ПО промежуточного уровня, которое занимается сбором,
...
![1_Domain_Logic.png](../RPCvsRESTvsMQ/1_Domain_Logic.png)
...
![2_Transaction_Script.gif](../RPCvsRESTvsMQ/2_Transaction_Script.gif)
...
![3_Table Handler.gif](../RPCvsRESTvsMQ/3_Table Handler.gif)
...
Объектная модель домена, объединяющая данные и поведение см. 

![4_Domain_Model.gif](../RPCvsRESTvsMQ/4_Domain_Model.gif)
...
агрегата из книги Эванса см. 

![5_Unit_Design.png](../RPCvsRESTvsMQ/5_Unit_Design.png)
...
- Эрик Эванс - Предметно-ориентированное проектирование (DDD): структуризация сложных программных систем - ISBN 978-5-6040724-9-3
...
---
См. [комментарии к статье в русском исходнике](https://habr.com/ru/articles/493676/).
