...
Обратите внимание, что атрибут `th:if` будет не только оценивать логические условия - *boolean*. Его возможности немного шире, и он
будет оценивать указанное выражение как *истинное - true*, следуя этим правилам:
