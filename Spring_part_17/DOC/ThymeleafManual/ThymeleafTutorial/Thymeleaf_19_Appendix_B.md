...
См. javadoc API для класса [ExecutionInfo](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/ExecutionInfo.html)
...
См. javadoc API для класса [Messages](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Messages.html)
...
См. javadoc API для класса [Uris](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Uris.html)
...
См. javadoc API для класса [Conversions](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Conversions.html)
...
См. javadoc API для класса [Dates](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Dates.html)
...
См. javadoc API для класса [Calendars](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Calendars.html)
...
См. javadoc API для класса [Numbers](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Numbers.html)
...
См. javadoc API для класса [Strings](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Strings.html)
...
См. javadoc API для класса [Objects](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Objects.html)

```
/* Возвращает объект, если он не null, и дефолтное значение в противном случае. Так же работает с arrays, lists или sets */
...
См. javadoc API для класса [Bools](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Bools.html)
...
См. javadoc API для класса [Arrays](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Arrays.html)
...
См. javadoc API для класса [Lists](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Lists.html)
...
См. javadoc API для класса [Sets](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Sets.html)
...
См. javadoc API для класса [Maps](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Maps.html)
...
См. javadoc API для класса [Aggregates](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Aggregates.html)
...
См. javadoc API для класса [Ids](https://www.thymeleaf.org/apidocs/thymeleaf/3.1.1.RELEASE/org/thymeleaf/expression/Ids.html)
...
[См. далее →](../ThymeleafTutorial/Thymeleaf_20_Appendix_C.md)
