...
режиме, встраиваемом внутри HTML-шаблона), Thymeleaf 3.0 позволяет избегать атрибуты элементов в его текстовом синтаксисе. 
...
[См. далее →](../ThymeleafTutorial/Thymeleaf_14.txt)
